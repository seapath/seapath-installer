...
class ImageSelectionPage : public QWidget
{
    Q_OBJECT
public:
    explicit ImageSelectionPage( Config* config, QWidget* parent = nullptr );
...
protected:
    ...
    void scanAvailableImages();


private:
    Ui::ImageSelectionPage* ui;
